<?php
if ( ! function_exists( 'peliarvostelut_net_2020_icons_facebook' ) ) :
  function peliarvostelut_net_2020_icons_facebook() {
    ?>
...
if ( ! function_exists( 'peliarvostelut_net_2020_icons_twitter' ) ) :
  function peliarvostelut_net_2020_icons_twitter() {
    ?>
